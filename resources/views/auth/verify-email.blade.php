...
<head>
    ...
    <style>
        ...
        body.bc-busy #verify-loader, body.bc-busy #verify-loader * { pointer-events: all !important; }
    </style>
</head>
<body class="flex items-center justify-center p-6 hero-bg">
    <div id="verify-loader">
        <div class="flex flex-col items-center">
            ...
            <p class="text-[10px] font-black uppercase tracking-[3px] text-orange-600">Communicating...</p>
        </div>
    </div>
    
    <script>
        document.addEventListener('submit', () => {
             document.getElementById('verify-loader').style.display = 'flex';
