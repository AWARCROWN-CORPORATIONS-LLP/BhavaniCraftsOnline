...
@section('header_extra')
    <div class="flex items-center space-x-4">
        <h2 class="text-xl lg:text-3xl font-black text-gray-900 uppercase tracking-tighter">Expand Catalog</h2>
        <span class="text-gray-300">/</span>
        <p class="text-[10px] items-center font-black text-[#ff9933] uppercase tracking-[4px]">Master Artifact Registry</p>
    </div>
@endsection
...
@section('content')
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="card-premium p-12 space-y-12">
            @csrf
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="telugu_name" placeholder="దివ్య దీపం" class="w-full bg-gray-50 border-none px-8 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select name="listed_status" required class="w-full bg-gray-50 border-none px-8 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all">
                            ...
                            <option value="Draft">Draft (In-Process)</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-8 mt-12">
                    <div class="flex items-center space-x-6">
                        <h3 class="text-xs font-black text-[#ff9933] uppercase tracking-[6px] leading-none italic">3D AR Vault (Optional)</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="p-8 bg-gray-50 border-2 border-dashed border-gray-100 rounded-[30px] flex flex-col items-center text-center">
                            ...
                            <button type="button" onclick="document.getElementById('glb_input').click()" class="px-6 py-4 bg-white border border-gray-200 rounded-2xl text-[10px] font-black text-gray-600 uppercase tracking-widest hover:border-[#ff9933] transition-all">Select GLB Model</button>
                            
                            <div id="glb_status" class="mt-4 text-[9px] font-bold text-[#ff9933] hidden uppercase tracking-widest">Master Model Selected</div>
                        </div>
                        ...
                        <div class="p-8 bg-gray-50 border-2 border-dashed border-gray-100 rounded-[30px] flex flex-col items-center text-center">
                            ...
                            <button type="button" onclick="document.getElementById('usdz_input').click()" class="px-6 py-4 bg-white border border-gray-200 rounded-2xl text-[10px] font-black text-gray-600 uppercase tracking-widest hover:border-[#ff9933] transition-all">Select USDZ Model</button>
                            <div id="usdz_status" class="mt-4 text-[9px] font-bold text-[#ff9933] hidden uppercase tracking-widest">AR Matrix Selected</div>
                        </div>
                    </div>
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <input type="number" name="price" step="0.01" required placeholder="599.00" class="w-full bg-gray-50 border-none px-6 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all text-gray-900">
                    </div>
                    <div>
                        ...
                        <input type="number" name="mrp" step="0.01" placeholder="999.00" class="w-full bg-gray-50 border-none px-6 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all text-gray-400">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" required placeholder="100" class="w-full bg-gray-50 border-none px-6 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="material_type" placeholder="Pure Panchadhatu" class="w-full bg-gray-50 border-none px-6 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <textarea name="short_description" rows="3" placeholder="Handcrafted with pure brass, perfect for Deepawali rituals..." class="w-full bg-gray-50 border-none px-6 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all">{{ old('short_description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="full_description" rows="6" placeholder="The intricate design represents the blessing of the divine..." class="w-full bg-gray-50 border-none px-6 py-5 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#ff9933]/20 transition-all">{{ old('full_description') }}</textarea>
                </div>
            </div>

            <div class="pt-10 flex items-center justify-between">
                <a href="{{ route('admin.products.index') }}" class="text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-red-500 transition-colors">Abort Registry</a>
                <button type="submit" class="btn-luxury-saffron px-12 py-5 text-[11px] shadow-2xl">Confirm & Register Master Artifact</button>
            </div>
        </form>
    </div>
