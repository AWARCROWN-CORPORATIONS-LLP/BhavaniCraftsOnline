...
<div class="max-w-5xl mx-auto space-y-12 pb-24">
    <!-- Header -->
    <div>
        <span class="text-[10px] font-black uppercase tracking-[4px] text-brand-500 block mb-2">Sacred Assembly</span>
        <h1 class="text-4xl font-black text-gray-900 tracking-tight italic">Assemble <span class="text-brand-500">Ritual Kit</span></h1>
        <p class="text-gray-400 text-xs font-bold uppercase tracking-widest mt-2">Curate a specialized collection of artifacts for sacred ceremonies</p>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.ritual-kits.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
        @csrf
                ...
                <div class="card-premium p-8 bg-white border-none shadow-2xl shadow-gray-200/50">
                    ...
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Grihapravesh Starter Kit" required 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" step="0.01" name="price" value="{{ old('price') }}" placeholder="Leave empty for auto-sum" 
                                   class="w-full bg-gray-50 border-gray-100 rounded-xl text-xs font-bold text-gray-900 h-14 px-4 focus:ring-brand-500 focus:border-brand-500 transition-all uppercase tracking-widest">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group h-40 bg-gray-50 border-2 border-dashed border-gray-100 rounded-2xl flex flex-col items-center justify-center transition-all hover:border-brand-500 cursor-pointer overflow-hidden">
                                ...
                                <div class="text-center" id="imagePlaceholder">
                                    ...
                                    <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Upload Kit Cover</p>
                                </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="card-premium p-8 bg-white border-none shadow-2xl shadow-gray-200/50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto no-scrollbar p-1">
                        ...
                        <label class="product-item flex items-center p-4 bg-gray-50 rounded-2xl border border-transparent hover:border-brand-500 cursor-pointer transition-all space-x-4">
                            <input type="checkbox" name="products[]" value="{{ $product->id }}" class="h-5 w-5 rounded-md text-brand-500 focus:ring-brand-500 border-gray-200">
                ...
                <div class="card-premium p-8 bg-white border-none shadow-2xl shadow-gray-200/50">
                     ...
                     <div class="space-y-2">
                        ...
                        <textarea name="description" rows="4" placeholder="Explain the ceremonial importance of this kit..."
                                  class="w-full bg-gray-50 border-gray-100 rounded-xl text-xs font-bold text-gray-900 p-4 focus:ring-brand-500 focus:border-brand-500 transition-all italic leading-relaxed">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end space-x-6 border-t border-gray-100 pt-10">
            ...
            <button type="submit" class="btn-luxury-saffron px-12 py-5 shadow-2xl shadow-brand-500/20 flex items-center space-x-4">
                <span class="text-xs">Finalize Assembly Ritual</span>
