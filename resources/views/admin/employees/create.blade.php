...
@section('header_extra')
    <h2 class="text-xl lg:text-3xl font-black text-gray-900 uppercase tracking-tighter">New Personnel Registry</h2>
@endsection
    ...
    <form action="{{ route('superadmin.employees.store') }}" method="POST" class="card-premium">
        ...
        <div class="p-8 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
            <div>
                ...
                <p class="text-2xl font-light text-gray-600">Register internal employee</p>
            </div>
        ...
        <div class="p-8 lg:p-12">
            <div class="max-w-3xl space-y-10">
                <!-- Name -->
                <div>
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[3px] mb-3">Full Legal Identity</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[3px] mb-3">Primary Contact Number</label>
                ...
                <div class="pt-10 border-t border-gray-100">
                    <button type="submit" class="btn-luxury-saffron w-full md:w-auto px-12 py-4 shadow-xl text-xs flex items-center justify-center space-x-4">
                        <span>Grant Official Employee Access</span>
