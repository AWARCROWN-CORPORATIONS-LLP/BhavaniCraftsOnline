        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                <thead class="bg-gray-50/50">
                    <tr>
                        <th class="p-8 text-[10px] font-black text-gray-400 uppercase tracking-[3px]">Order Sequence</th>
                        <th class="p-8 text-[10px] font-black text-gray-400 uppercase tracking-[3px]">Seeker Identity</th>
                        <th class="p-8 text-[10px] font-black text-gray-400 uppercase tracking-[3px]">Financial Value</th>
                        <th class="p-8 text-[10px] font-black text-gray-400 uppercase tracking-[3px]">Registry Status</th>
