...
<div class="space-y-8 animate-fadeIn">
    ...
    <div class="bg-onyx-900 rounded-[2rem] p-10 text-white relative overflow-hidden shadow-2xl">
        <div class="relative z-10">
            ...
            <p class="text-white/60 text-sm font-medium">Continue your shopping journey.</p>
        </div>
        <!-- Decorative element -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 group hover:border-brand-500/30 transition-all duration-500">
            ...
            <p class="text-[10px] font-black uppercase tracking-[2px] text-gray-400 mb-1">My Wishlist</p>
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div class="max-w-xl">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <h3 class="text-lg font-black text-onyx-900 uppercase tracking-widest italic">Wishlist Sharing</h3>
                </div>
                <p class="text-sm text-gray-400 font-medium leading-relaxed">
                    Planning a ceremony or wedding? Generate a link to share your wishlist with family and friends via WhatsApp or Email.
                </p>
                ...
                <div class="mt-6 p-4 bg-gray-50 rounded-2xl border border-dashed border-gray-200 flex items-center justify-between group/link">
                    <div class="flex flex-col">
                        <span class="text-[8px] font-black uppercase tracking-widest text-gray-400 mb-1">Your Share Link</span>
                ...
                <div class="mt-6 flex items-center space-x-4">
                    <!-- WhatsApp Share -->
                    <a href="https://wa.me/?text={{ urlencode('Discover my wishlist from Bhavani Crafts: ' . route('collection.show', Auth::user()->wishlist_token)) }}" 
                       target="_blank"
                    ...
                    <!-- Email Share -->
                    <a href="mailto:?subject={{ urlencode('My Wishlist') }}&body={{ urlencode('I wanted to share my wishlist from Bhavani Crafts with you: ' . route('collection.show', Auth::user()->wishlist_token)) }}" 
                ...
                <!-- NEW FEATURE: Print-Ready QR Code -->
                <div class="mt-8 flex items-start space-x-6 p-6 bg-white border border-gray-100 rounded-3xl shadow-sm">
                    <div class="p-3 bg-gray-50 rounded-2xl border border-gray-200 shadow-inner group-hover:border-brand-500/30 transition-colors">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&color=2E2E2E&bgcolor=FFFFFF&data={{ urlencode(route('collection.show', Auth::user()->wishlist_token)) }}" 
                             alt="Collection QR Code" class="h-24 w-24 object-contain rounded-xl mix-blend-multiply">
                    </div>
                    <div>
                        <h4 class="text-xs font-black uppercase tracking-widest text-onyx-900 mb-2">Wishlist QR Code</h4>
                        <p class="text-[10px] font-bold text-gray-400 leading-relaxed mb-4 max-w-xs">
                        ...
                        <a href="https://api.qrserver.com/v1/create-qr-code/?size=500x500&color=2E2E2E&bgcolor=FFFFFF&data={{ urlencode(route('collection.show', Auth::user()->wishlist_token)) }}" 
                           ...
                           class="inline-flex items-center space-x-2 text-[9px] font-black uppercase tracking-widest text-brand-500 hover:text-brand-600 transition-colors">
                            ...
                            <span>Download HQ Print File</span>
                        </a>
                    </div>
                </div>
                @endif
            ...
            <form action="{{ route('customer.wishlist.toggle_sharing') }}" method="POST">
                ...
                <button type="submit" 
                    ...
                    {{ Auth::user()->wishlist_public ? 'Make Private' : 'Enable Sharing' }}
                </button>
            </form>
        </div>
    </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-8 py-6 text-right text-sm font-black text-brand-500">
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden mb-12">
        <div class="px-8 py-6 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-sm font-black uppercase tracking-widest text-onyx-900">Recent Orders</h3>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50">
                        ...
                        <th class="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-gray-400 text-right">Total Amount</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        <td colspan="4" class="px-8 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-sm font-bold text-gray-400 uppercase tracking-widest italic">No orders yet.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
