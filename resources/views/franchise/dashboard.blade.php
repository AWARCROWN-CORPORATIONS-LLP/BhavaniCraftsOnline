...
@section('header_extra')
    <h2 class="text-xl lg:text-2xl font-black text-gray-900 uppercase tracking-tight">Partner Performance</h2>
@endsection
...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="card-premium p-8 relative overflow-hidden flex flex-col justify-between h-[220px]">
            ...
            <div class="z-10 flex items-center justify-between">
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none">Profit Registry</p>
        ...
        <div class="card-premium p-8 relative overflow-hidden flex flex-col justify-between h-[220px]">
            <div class="z-10">
                <p class="text-[9px] font-black text-[#ff9933] uppercase tracking-[4px] mb-2 leading-none">Registry Entries</p>
                <h3 class="text-4xl lg:text-5xl font-black text-gray-900 leading-none tracking-tighter">{{ $stats['orders_count'] }}</h3>
            </div>
            <div class="z-10 flex items-center justify-between">
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none">History Log</p>
        ...
        <div class="card-premium p-8 relative overflow-hidden flex flex-col justify-between h-[220px] bg-gradient-to-br from-white to-gray-50 border-orange-100">
            <div class="z-10">
                <p class="text-[9px] font-black text-[#ff9933] uppercase tracking-[4px] mb-2 leading-none">Active Flows</p>
                <h3 class="text-4xl lg:text-5xl font-black text-gray-900 leading-none tracking-tighter">{{ $stats['pending_shipments'] }}</h3>
            </div>
            <div class="z-10 flex items-center justify-between">
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none">Supply Queue</p>
        ...
        <div class="card-premium p-8 relative overflow-hidden flex flex-col justify-between h-[220px]">
            <div class="z-10">
                <p class="text-[9px] font-black text-[#ff9933] uppercase tracking-[4px] mb-2 leading-none">Artifact Inventory</p>
                <h3 class="text-4xl lg:text-5xl font-black text-gray-900 leading-none tracking-tighter">{{ $stats['inventory_size'] }}</h3>
            </div>
            <div class="z-10 flex items-center justify-between">
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none">Personal Silk</p>
    ...
    <div class="mt-16">
        <div class="flex items-center space-x-6 mb-8">
            <h2 class="text-2xl font-black text-gray-900 uppercase">Latest Supply Orders</h2>
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-50/50">
                    <tr>
                        ...
                        <th class="p-6 text-[10px] font-black text-gray-400 uppercase tracking-[3px]">Registry Date</th>
                    ...
                    @forelse($recentOrders as $order)
                        <tr class="hover:bg-gray-50/30 transition-all group">
                            ...
                            <td class="p-6 text-right">
                                <button class="text-[10px] font-black text-[#ff9933] uppercase tracking-[3px] hover:underline">Track Silk</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="p-20 text-center opacity-30">
                                <p class="text-[10px] font-black uppercase tracking-[8px]">No Registry Entries Yet</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
