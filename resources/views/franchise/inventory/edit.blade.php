...
@section('header_extra')
    <div class="flex items-center space-x-4">
        ...
        <p class="text-[10px] items-center font-black text-[#ff9933] uppercase tracking-[4px]">Private Collection Edit</p>
    </div>
@endsection
...
@section('content')
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('franchise.inventory.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="card-premium p-12 space-y-12">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-8">
                <div class="flex items-center space-x-6">
                    <h3 class="text-xs font-black text-gray-400 uppercase tracking-[6px] leading-none">Sacred Trinity Suite</h3>
                    <div class="flex-grow h-[1px] bg-gray-100"></div>
                </div>
                ...
                <div class="p-10 border-2 border-dashed border-gray-100 rounded-[30px] bg-gray-50/50 flex flex-col items-center text-center mt-8">
                    ...
                    <p class="text-[12px] font-black text-gray-900 uppercase tracking-widest mb-2">Replace Visual Trinity (Optional)</p>
                    <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-6">Exactly 3 images required to refine the visual presentation.</p>
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <label class="text-[10px] font-black text-gray-600 tracking-[3px] uppercase mb-4 block ml-1 leading-none">Current Stock Units</label>
            ...
            <div class="pt-10 flex items-center justify-between">
                <a href="{{ route('franchise.inventory') }}" class="text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-red-500 transition-colors">Discard Revisions</a>
                <button type="submit" class="btn-luxury-saffron px-12 py-5 text-[11px] shadow-2xl">Confirm Artifact Update</button>
            </div>
        </form>
    </div>
